...
class MyRoutesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "routeID", for: indexPath) as! myRouteCell
        ...
        cell.type.text = routePost.getRoute().getActivityType()
        
        cell.view.tag = indexPath.row
        cell.view.addTarget(self, action: #selector(connected(sender:)), for: .touchUpInside)
    ...
    func segueToPostViewVC (_ sender: Any) {
        performSegue(withIdentifier: "fromMyPostVCTOView", sender: self)
    }
